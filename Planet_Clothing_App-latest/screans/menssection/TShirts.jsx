...
const TShirt = ({navigation}) => {
  const valueToPass = ['Top_Tab_Navigation','TShirts'];
  const singleproduct = () => {
    ...
    return (
        ...
        <Text style={{color:'white',fontSize:hp('2%'),letterSpacing:hp('0.5%')}}>Trends, In Demand</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  imagesliderheader:{
    ...
    alignItems:'center',
    borderTopRightRadius:wp('0.8%'),
    borderTopLeftRadius:wp('0.8%')
},
imagecontainer:{
  height:hp('22%'),
  width:wp('100%'),
