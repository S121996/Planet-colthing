...
const TopTabScrean = ({navigation,descriptors,state}) => {
    ...
    useEffect(() => {
      ...
      const isHomeSection = state.routes[state.index].name === 'HomeSection';
  return (
    <View style={styles.main}>
    <View style={styles.contentbar}>
    <View style={[styles.content1,{display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'space-around',backgroundColor:'white'}]}><View style={{height:responsiveWidth(6),width:responsiveWidth(6)}}><TouchableOpacity onPress={()=>navigation.navigate('Filter')}><Image resizeMode='contain' style={{height:responsiveWidth(6),width:responsiveWidth(6)}} source={require('../../assets/mens_categories_images/Layer2.png')}/></TouchableOpacity></View><View><TouchableOpacity onPress={()=>navigation.navigate('HomeSection')}><Image style={{height:responsiveHeight(4),width:responsiveWidth(8)}} source={require('../../assets/mens_categories_images/Ellipse.png')}/></TouchableOpacity></View></View>
    <TouchableOpacity onPress={()=>navigation.navigate('Shirts')}><View style={styles.content}><Text style={{fontSize:responsiveFontSize(1.9),color:'black'}}>Shirts</Text></View></TouchableOpacity>
    <TouchableOpacity onPress={()=>navigation.navigate('TShirts')}><View style={styles.content}><Text style={{fontSize:responsiveFontSize(1.9),color:'black'}}>TShirts</Text></View></TouchableOpacity>
    <TouchableOpacity onPress={()=>navigation.navigate('Pants')}><View style={styles.content}><Text style={{fontSize:responsiveFontSize(1.9),color:'black'}}>Pants</Text></View></TouchableOpacity>
    </View>
