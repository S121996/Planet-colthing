...
const TopWear = ({navigation}) => {
    const arr = [1,2,3,4];
    const valueToPass = 'BottomWear';
    /* temperory object */
    const imagemap = {
      one: require('../../assets/tempimages/5.png'),
      two: require('../../assets/tempimages/6.png'),
      three: require('../../assets/tempimages/7.png'),
      four: require('../../assets/tempimages/8.png'),
  }
  const singleproduct = () => {
    ...
    return (
        ...
        <Image source={require('../../assets/mens_categories_images/temp2.png')} resizeMode='cover'/>
        </View>
