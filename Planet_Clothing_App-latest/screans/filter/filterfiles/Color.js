...
const Color = ({ searchQuery = '', setSearchQuery = () => {}, navigation }) => {
  const [selectedSize, setSelectedSize] = useState(null);
  const [selectedCategory, setSelectedCategory] = useState('Size');
 

  const handleSizeSelect = (color) => {
  ...
  const applyFilters = () => {
    ...
    navigation.navigate('FilteredResults', { selectedSize, selectedCategory });
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.mainContent}>
        ...
        <View style={styles.sizeOptions}>
          {['Red', 'Blue', 'Yellow', 'Black', 'Orange'].map((size) => (
