...
const Pattern = ({ searchQuery = '', setSearchQuery = () => {}, navigation }) => {
    ...
    <SafeAreaView style={styles.safeArea}>   
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.ratingOptions}>
          <Text style={{textAlign:'center',fontWeight:'bold'}}>TOP PICKS</Text>
  {['Printed', 'Checked', 'Solid'].map((rating) => (
    <TouchableOpacity
      key={rating}
...
<View style={styles.ratingOptions}>
  <Text style={{textAlign:'center',fontWeight:'bold'}}>MORE OPTIONS</Text>
  {['SelfDesign','Striptd', 'Faded', 'Colourblocked'].map((rating) => (
    <TouchableOpacity
      key={rating}
      onPress={() => setSelectedRating(rating)}
      style={[
