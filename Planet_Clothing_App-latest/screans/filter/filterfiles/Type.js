...
const Type = ({ searchQuery = '', setSearchQuery = () => {}, navigation }) => {
  ...
  const applyFilters = () => {
    ...
    navigation.navigate('FilteredResults', { selectedType, selectedCategory });
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.typeOptions}>
          {['Casual Shoe', 'Sport Shoe', 'Formal Shoe', 'Boats'].map((type) => (
            <TouchableOpacity
              key={type}
