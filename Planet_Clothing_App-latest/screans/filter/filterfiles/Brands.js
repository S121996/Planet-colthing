...
const Brands = ({ searchQuery = '', setSearchQuery = () => {}, navigation }) => {
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.brandOptions}>
          <TouchableOpacity
            key="Cloths"
            onPress={() => {
              handleBrandSelect('Cloths');
              navigation.navigate('Cloths');
            }}>
            <Text
              style={[
                styles.brandOption,
                selectedBrand === 'Cloths' && styles.selectedBrandOption,
              ]}>
              Cloths
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            key="Shoes"
            onPress={() => {
              handleBrandSelect('Shoes');
              navigation.navigate('Shoes');
            }}>
            <Text
              style={[
                styles.brandOption,
                selectedBrand === 'Shoes' && styles.selectedBrandOption,
              ]}>
              Shoes
            </Text>
          </TouchableOpacity>
