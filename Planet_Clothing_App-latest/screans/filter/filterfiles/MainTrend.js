...
const MainTrend = ({ searchQuery = '', setSearchQuery = () => {}, navigation }) => {
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.ratingOptions}>
          <ScrollView>
            ...
            {[
              'Abstract', 'Animal or Skin Print', 'Colourblocked', 'Conversational Print',
              'Crochet', 'Ethnic Print', 'Geometric Print', 'Indigo', 'Monochrome', 
              'Micro or Ditsy Print', 'Nautical', 'New Basics', 'Pastels', 'Placement Print',
              'Multi or Variegated Stripes', 'Tie and Dye', 'Tropical'
            ].map((rating) => (
              <TouchableOpacity
                key={rating}
...
const styles = StyleSheet.create({
  ...
  ratingOptions: {
    top: 20,
    width: '50%', // Ensure proper width for scrollable area
  },
  ratingOption: {
    marginVertical: 5,
    borderRadius: 10,
